        ...
        <Row className="login-form">
          <Col xs={12} md={6}>
            ...
            >
              ...
              >
                <div className="landing_form--googleButtonInner--3RQWE __web-inspector-hide-shortcut__">
                  <span className=" landing_form--googleIcon--3Q7rS me-2">
                    <svg
                      className="svg"
                      width="18"
                      height="18"
            ...
            {!isLoading && (
              <form onSubmit={handleLoginSubmit}>
                ...
                <br />
                <Button
                  className="zara-btn btn btn-dark btn-primary"
                  style={{ width: "75%" }}
                  type="submit"
                >
                  Login
